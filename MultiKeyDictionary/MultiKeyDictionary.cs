...
{
    public class Dictionary<TKey1, TKey2, TValue> : Dictionary<MultiKey<TKey1, TKey2>, TValue>
    {
        ...
        {
            return this.ContainsKey(KeyCreator(key1, key2));
        }

        public bool Remove(TKey1 key1, TKey2 key2)
        {
            return this.Remove(KeyCreator(key1, key2));
        }

        public bool TryGetValue(TKey1 key1, TKey2 key2, out TValue value)
        {
            return this.TryGetValue(KeyCreator(key1, key2), out value);
        }
